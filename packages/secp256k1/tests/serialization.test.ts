/**
 * Serialization tests for FROST secp256k1-SHA256.
 * Ported from frost-secp256k1/tests/serialization_tests.rs
 *
 * These tests verify that all FROST data structures can be correctly
 * serialized and deserialized using their native binary format.
 *
...
describe("FROST secp256k1-SHA256 Serialization Tests", () => {
  describe("SigningNonces Serialization", () => {
    it("should serialize and deserialize SigningNonces correctly", () => {
      ...
      const hidingNonce = Nonce.deserialize(Secp256K1Sha256, hidingBytes);
      const bindingNonce = Nonce.deserialize(Secp256K1Sha256, bindingBytes);
      const deserialized = SigningNonces.fromNonces(Secp256K1Sha256, hidingNonce, bindingNonce);
  ...
  describe("SigningCommitments Serialization", () => {
    it("should serialize and deserialize SigningCommitments correctly", () => {
      ...
      // Deserialize components back
      const hidingCommitment = NonceCommitment.deserialize(Secp256K1Sha256, hidingBytes);
      const bindingCommitment = NonceCommitment.deserialize(Secp256K1Sha256, bindingBytes);
  ...
  describe("SigningPackage Serialization", () => {
    it("should serialize and deserialize SigningPackage correctly", () => {
      ...
      const deserialized = SigningPackageImpl.create(Secp256K1Sha256, commitments, message);
  ...
  describe("SignatureShare Serialization", () => {
    it("should serialize and deserialize SignatureShare correctly", () => {
      ...
      const deserialized = SignatureShare.deserialize(Secp256K1Sha256, bytes);
  ...
  describe("PublicKeyPackage Serialization", () => {
    it("should serialize and deserialize PublicKeyPackage correctly (legacy)", () => {
      ...
      const deserialized = new PublicKeyPackage(Secp256K1Sha256, verifyingShares, verifyingKey);

      // Verify round-trip
      expect(deserialized.verifyingShares.size).toBe(pkg.verifyingShares.size);
      expect(bytesToHex(Secp256K1Sha256.serializeElement(deserialized.verifyingKey))).toBe(
  ...
  describe("DKG Round1 SecretPackage Serialization", () => {
    it("should serialize and deserialize round1::SecretPackage correctly", () => {
      ...
      const deserialized = new dkg.round1.SecretPackage(
        Secp256K1Sha256,
        identifier as any,
        coefficients as any,
        commitment as any,
  ...
  describe("DKG Round1 Package Serialization", () => {
    it("should serialize and deserialize round1::Package correctly", () => {
      ...
      const deserialized = new dkg.round1.Package(Secp256K1Sha256, commitment, proofOfKnowledge);
  ...
  describe("DKG Round2 SecretPackage Serialization", () => {
    it("should serialize and deserialize round2::SecretPackage correctly", () => {
      ...
      /* eslint-disable @typescript-eslint/no-explicit-any */
      const deserialized = new dkg.round2.SecretPackage(
        Secp256K1Sha256,
        identifier as any,
        commitment as any,
  ...
  describe("DKG Round2 Package Serialization", () => {
    it("should serialize and deserialize round2::Package correctly", () => {
      ...
      const deserialized = new dkg.round2.Package(Secp256K1Sha256, signingShareVal as any);
