/**
 * JSON serialization (serde) support for FROST secp256k1-SHA256.
 *
...
import { Secp256K1Sha256, type Secp256K1Sha256Impl, Identifier } from "./index.js";
...
export function signingCommitmentsToJson(
  commitments: SigningCommitments<Secp256K1Sha256Impl>,
 ...
 */
export function signingCommitmentsFromJson(json: unknown): SigningCommitments<Secp256K1Sha256Impl> {
  ...
  const hiding = NonceCommitment.deserialize(Secp256K1Sha256, hidingBytes);
  const binding = NonceCommitment.deserialize(Secp256K1Sha256, bindingBytes);

  return new SigningCommitments(Secp256K1Sha256, hiding, binding);
}
 ...
 */
export function signingPackageToJson(pkg: SigningPackage<Secp256K1Sha256Impl>): SigningPackageJson {
 ...
 */
export function signingPackageFromJson(json: unknown): SigningPackage<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const commitmentsMap = new Map<
    Identifier<Secp256K1Sha256Impl>,
    SigningCommitments<Secp256K1Sha256Impl>
  >();
  ...
  for (const [idHex, commitmentJson] of Object.entries(commitmentsObj)) {
    ...
    const id = Identifier.deserialize(Secp256K1Sha256, idBytes);
  ...
  return new SigningPackageImpl(Secp256K1Sha256, commitmentsMap, message);
}
...
export function signatureShareToJson(
  share: SignatureShare<Secp256K1Sha256Impl>,
): SignatureShareJson {
  return {
    header: { ...DEFAULT_HEADER },
 ...
 */
export function signatureShareFromJson(json: unknown): SignatureShare<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  return SignatureShare.deserialize(Secp256K1Sha256, shareBytes);
}
 ...
 */
export function secretShareToJson(share: SecretShare<Secp256K1Sha256Impl>): SecretShareJson {
  return {
    header: { ...DEFAULT_HEADER },
 ...
 */
export function secretShareFromJson(json: unknown): SecretShare<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const signingShare = SigningShare.deserialize(Secp256K1Sha256, signingShareBytes);
  ...
  return new SecretShare(Secp256K1Sha256, id, signingShare, commitment);
}
 ...
 */
export function keyPackageToJson(pkg: KeyPackage<Secp256K1Sha256Impl>): KeyPackageJson {
  return {
    header: { ...DEFAULT_HEADER },
    ...
    verifying_key: bytesToHex(Secp256K1Sha256.serializeElement(pkg.verifyingKey)),
 ...
 */
export function keyPackageFromJson(json: unknown): KeyPackage<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const verifyingShare = VerifyingShare.deserialize(Secp256K1Sha256, verifyingShareBytes);

  const verifyingKeyBytes = hexToBytes(obj["verifying_key"] as string);
  const verifyingKey = Secp256K1Sha256.deserializeElement(verifyingKeyBytes);
...
export function publicKeyPackageToJson(
  pkg: PublicKeyPackage<Secp256K1Sha256Impl>,
 ...
 */
export function publicKeyPackageFromJson(json: unknown): PublicKeyPackage<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const verifyingShares = new Map<string, VerifyingShare<Secp256K1Sha256Impl>>();

  for (const [idHex, shareHex] of Object.entries(verifyingSharesObj)) {
    // Validate the identifier is not all zeros
    const idBytes = hexToBytes(idHex);
    Identifier.deserialize(Secp256K1Sha256, idBytes); // This will throw if invalid (all zeros)

    const shareBytes = hexToBytes(shareHex);
    const share = VerifyingShare.deserialize(Secp256K1Sha256, shareBytes);
  ...
  return new PublicKeyPackage(Secp256K1Sha256, verifyingShares, verifyingKey, minSigners);
}
 ...
 */
export function round1PackageToJson(pkg: round1.Package<Secp256K1Sha256Impl>): Round1PackageJson {
  // Serialize the proof of knowledge (DkgSignature) as R || z
  const pokR = Secp256K1Sha256.serializeElement(pkg.proofOfKnowledge.R);
  const pokZ = Secp256K1Sha256.serializeScalar(pkg.proofOfKnowledge.z);
 ...
 */
export function round1PackageFromJson(json: unknown): round1.Package<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const elementSize = Secp256K1Sha256.elementSize();
  const scalarSize = Secp256K1Sha256.scalarSize();
  ...
  const R = Secp256K1Sha256.deserializeElement(pokBytes.slice(0, elementSize));
  const z = Secp256K1Sha256.deserializeScalar(pokBytes.slice(elementSize));
  ...
  return {
    ...
    serialize(): Uint8Array[] {
      ...
      const pokR = Secp256K1Sha256.serializeElement(proofOfKnowledge.R);
      const pokZ = Secp256K1Sha256.serializeScalar(proofOfKnowledge.z);
  ...
  } as unknown as round1.Package<Secp256K1Sha256Impl>;
}
 ...
 */
export function round2PackageToJson(pkg: round2.Package<Secp256K1Sha256Impl>): Round2PackageJson {
  return {
    header: { ...DEFAULT_HEADER },
    signing_share: bytesToHex(pkg.signingShare.serialize()),
  };
 ...
 */
export function round2PackageFromJson(json: unknown): round2.Package<Secp256K1Sha256Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  } as unknown as round2.Package<Secp256K1Sha256Impl>;
}
