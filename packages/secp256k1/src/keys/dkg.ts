...
import {
  round1 as coreRound1,
  round2 as coreRound2,
  part1 as corePart1,
  part2 as corePart2,
  part3 as corePart3,
} from "@frosts/core";
...
export namespace round1 {
  ...
  // Re-export class constructors for runtime use
  export const SecretPackage = coreRound1.SecretPackage;
  export const Package = coreRound1.Package;
}
...
export namespace round2 {
  ...
  // Re-export class constructors for runtime use
  export const SecretPackage = coreRound2.SecretPackage;
  export const Package = coreRound2.Package;
}
