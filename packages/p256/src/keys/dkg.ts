/**
 * DKG (Distributed Key Generation) module for FROST(P-256, SHA-256).
 *
...
import type { P256Sha256Impl } from "../index.js";
 ...
 *
 * @param ciphersuite - The P256Sha256 ciphersuite instance
