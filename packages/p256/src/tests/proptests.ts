/**
 * Property-based tests for FROST-P256-SHA256.
 * Ported from frost-p256/src/tests/proptests.rs
 *
...
export class SignatureCase<_C> {
  ...
  /** Get the message for this test case */
  get message(): Uint8Array {
    return this._message;
  }

  /** Get the RNG seed for this test case */
  get rngSeed(): Uint8Array {
  ...
  check(): boolean {
    ...
    const hasBreakingTweak = this._tweaks.some((t) => t.type !== TweakType.None);
    void hasBreakingTweak; // Will be used when full implementation is complete
...
describe("P256-SHA256 Property Tests", () => {
