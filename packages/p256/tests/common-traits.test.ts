/**
 * Common traits tests for FROST P256-SHA256.
 * Ported from frost-p256/tests/common_traits_tests.rs
 *
...
describe("FROST P256-SHA256 Common Traits Tests", () => {
