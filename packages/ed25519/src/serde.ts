/**
 * JSON serialization (serde) support for FROST Ed25519-SHA512.
 *
...
export function signingCommitmentsToJson(
  commitments: SigningCommitments<Ed25519Sha512Impl>,
 ...
 */
export function signingCommitmentsFromJson(json: unknown): SigningCommitments<Ed25519Sha512Impl> {
  ...
  const hiding = NonceCommitment.deserialize(Ed25519Sha512, hidingBytes);
  const binding = NonceCommitment.deserialize(Ed25519Sha512, bindingBytes);
 ...
 */
export function signingPackageToJson(pkg: SigningPackage<Ed25519Sha512Impl>): SigningPackageJson {
 ...
 */
export function signingPackageFromJson(json: unknown): SigningPackage<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const commitmentsMap = new Map<
    Identifier<Ed25519Sha512Impl>,
    SigningCommitments<Ed25519Sha512Impl>
  >();
  ...
  for (const [idHex, commitmentJson] of Object.entries(commitmentsObj)) {
    ...
    const id = Identifier.deserialize(Ed25519Sha512, idBytes);
  ...
  return new SigningPackageImpl(Ed25519Sha512, commitmentsMap, message);
}
 ...
 */
export function signatureShareToJson(share: SignatureShare<Ed25519Sha512Impl>): SignatureShareJson {
  return {
    header: { ...DEFAULT_HEADER },
 ...
 */
export function signatureShareFromJson(json: unknown): SignatureShare<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  return SignatureShare.deserialize(Ed25519Sha512, shareBytes);
}
 ...
 */
export function secretShareToJson(share: SecretShare<Ed25519Sha512Impl>): SecretShareJson {
  return {
    header: { ...DEFAULT_HEADER },
 ...
 */
export function secretShareFromJson(json: unknown): SecretShare<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const signingShare = SigningShare.deserialize(Ed25519Sha512, signingShareBytes);

  const commitmentHexes = obj["commitment"] as string[];
  const commitmentBytes = commitmentHexes.map(hexToBytes);
  const commitment = VerifiableSecretSharingCommitment.deserialize(Ed25519Sha512, commitmentBytes);
 ...
 */
export function keyPackageToJson(pkg: KeyPackage<Ed25519Sha512Impl>): KeyPackageJson {
  return {
    header: { ...DEFAULT_HEADER },
    ...
    verifying_key: bytesToHex(Ed25519Sha512.serializeElement(pkg.verifyingKey)),
 ...
 */
export function keyPackageFromJson(json: unknown): KeyPackage<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const verifyingShare = VerifyingShare.deserialize(Ed25519Sha512, verifyingShareBytes);

  const verifyingKeyBytes = hexToBytes(obj["verifying_key"] as string);
  const verifyingKey = Ed25519Sha512.deserializeElement(verifyingKeyBytes);
...
export function publicKeyPackageToJson(
  pkg: PublicKeyPackage<Ed25519Sha512Impl>,
 ...
 */
export function publicKeyPackageFromJson(json: unknown): PublicKeyPackage<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const verifyingShares = new Map<string, VerifyingShare<Ed25519Sha512Impl>>();

  for (const [idHex, shareHex] of Object.entries(verifyingSharesObj)) {
    // Validate the identifier is not all zeros
    const idBytes = hexToBytes(idHex);
    Identifier.deserialize(Ed25519Sha512, idBytes); // This will throw if invalid (all zeros)
  ...
  return new PublicKeyPackage(Ed25519Sha512, verifyingShares, verifyingKey, minSigners);
}
 ...
 */
export function round1PackageToJson(pkg: round1.Package<Ed25519Sha512Impl>): Round1PackageJson {
  // Serialize the proof of knowledge (DkgSignature) as R || z
  const pokR = Ed25519Sha512.serializeElement(pkg.proofOfKnowledge.R);
  const pokZ = Ed25519Sha512.serializeScalar(pkg.proofOfKnowledge.z);
 ...
 */
export function round1PackageFromJson(json: unknown): round1.Package<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  const scalarSize = Ed25519Sha512.scalarSize();
  ...
  return {
    ...
    serialize(): Uint8Array[] {
      ...
      const pokR = Ed25519Sha512.serializeElement(proofOfKnowledge.R);
      const pokZ = Ed25519Sha512.serializeScalar(proofOfKnowledge.z);
  ...
  } as unknown as round1.Package<Ed25519Sha512Impl>;
}
 ...
 */
export function round2PackageToJson(pkg: round2.Package<Ed25519Sha512Impl>): Round2PackageJson {
  return {
    header: { ...DEFAULT_HEADER },
    signing_share: bytesToHex(pkg.signingShare.serialize()),
  };
 ...
 */
export function round2PackageFromJson(json: unknown): round2.Package<Ed25519Sha512Impl> {
  if (typeof json !== "object" || json === null) {
    throw new Error("Invalid JSON: expected object");
  }
  const obj = json as Record<string, unknown>;
  ...
  } as unknown as round2.Package<Ed25519Sha512Impl>;
}
