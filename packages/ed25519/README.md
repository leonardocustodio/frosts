...
- **RFC 9591 Compliant**: Implements the FROST protocol as specified in RFC 9591 Section 6.1

## Ciphersuite Parameters

| Parameter | Value |
|-----------|-------|
| Curve | Ed25519 (Edwards Curve over prime field) |
| Hash Function | SHA-512 |
| Scalar Size | 32 bytes |
| Element Size | 32 bytes (compressed Edwards point) |
...
- [RFC 9591: Two-Round Threshold Schnorr Signatures with FROST](https://datatracker.ietf.org/doc/rfc9591/) - Section 6.1 for Ed25519 ciphersuite
- [The ZF FROST Book](https://frost.zfnd.org/)
- [Ed25519](https://ed25519.cr.yp.to/) - Details on the Ed25519 signature scheme
