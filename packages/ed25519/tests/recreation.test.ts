/**
 * Recreation tests for FROST Ed25519-SHA512.
 * Ported from frost-ed25519/tests/recreation_tests.rs
 *
...
describe("FROST Ed25519-SHA512 Recreation Tests", () => {
  ...
  describe("SigningShare Recreation", () => {
    it("should recreate SigningShare via serialization", () => {
      const scalar = ciphersuite.deserializeScalar(scalar1());
      const signingShare = new SigningShare(ciphersuite, scalar);
