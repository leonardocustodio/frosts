...
export function verifySignature(
  ...
  if (groupSignature.length !== SIGNATURE_LENGTH) {
    throw new Error(
      `Invalid signature length: ${groupSignature.length}, expected ${SIGNATURE_LENGTH}`,
    );
  }
 ...
 * These are imported from the frost-secp256k1-tr vectors.json file.
 */
    ...
    outputs: [
      {
        ...
        hiding_nonce_commitment:
          "024e34ab3a7ad6b4563dbfe97e9f1206b3378cceb2502491ed0fb709765e1e5ba8",
        binding_nonce_commitment:
          "03d4b1f3a61dc67e64dfb4abfccabb712f1f6914a6ec9b67749d171370453192cb",
      },
      {
        identifier: 3,
        hiding_nonce_randomness: "70818dd5170672c4a4285fd593d4f222417f941f3118e1244955e7a1098a35d8",
        binding_nonce_randomness:
          "74ca2da071ed4a2a6cad5087d6758b48a558ab5861c61117fee05757e4b1309e",
        ...
        hiding_nonce_commitment:
          "02d768658a1b94225645401a1512b803657770c7a21bf9ccccccfa09930a44951b",
        binding_nonce_commitment:
          "034570a4e5217ee8770a28401185f50b4fce4d3f3933a3af9df7ab39b42381d0eb",
      },
    ],
  },
  round_two_outputs: {
