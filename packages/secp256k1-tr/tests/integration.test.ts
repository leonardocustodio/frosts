...
describe("FROST secp256k1-SHA256-TR Integration Tests", () => {
  ...
  describe("DKG (Distributed Key Generation)", () => {
    // TODO: DKG signing for Taproot requires special handling for BIP-340
    // The DKG-generated keys need Y-coordinate normalization that isn't yet implemented.
    // See: https://github.com/ZcashFoundation/frost/blob/main/frost-secp256k1-tr/src/lib.rs
    it.skip("should complete full signing flow with DKG", async () => {
