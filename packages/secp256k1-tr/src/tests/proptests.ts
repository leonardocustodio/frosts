/**
 * Property-based tests for FROST-secp256k1-SHA256-TR (Taproot).
 * Ported from frost-secp256k1-tr/src/tests/proptests.rs
 *
...
export class SignatureCase<_C> {
  ...
  check(): boolean {
    ...
    void _hasBreakingTweak; // Will be used when signature verification is implemented
...
describe("Secp256K1-SHA256-TR Property Tests", () => {
