/**
 * Repairable Threshold Scheme module for FROST(ristretto255, SHA-512).
 *
 ...
 */
export type Delta = CoreDelta<R>;

/**
 * A sigma value which is the output of step 2 of RTS.
 */
export type Sigma = CoreSigma<R>;
 ...
 */
export function repairShareStep2(ciphersuite: R, deltas: Delta[]): Sigma {
