/**
 * DKG (Distributed Key Generation) module for FROST(ristretto255, SHA-512).
 *
...
export namespace round1 {
   ...
   */
  export type SecretPackage = coreRound1.SecretPackage<R>;

  /**
   * The package that must be broadcast by each participant to all other participants
   * between the first and second parts of the DKG protocol (round 1).
   */
  export type Package = coreRound1.Package<R>;
}
...
export namespace round2 {
   ...
   * This package MUST NOT be sent to other participants!
   */
  export type SecretPackage = coreRound2.SecretPackage<R>;
   ...
   */
  export type Package = coreRound2.Package<R>;
}
