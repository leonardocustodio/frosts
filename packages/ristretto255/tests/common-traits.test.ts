/**
 * Common traits tests for FROST Ristretto255-SHA512.
 * Ported from frost-ristretto255/tests/common_traits_tests.rs
 *
...
describe("FROST Ristretto255-SHA512 Common Traits Tests", () => {
