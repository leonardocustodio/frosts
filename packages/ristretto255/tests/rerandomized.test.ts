/**
 * Re-randomized FROST tests for Ristretto255-SHA512.
 * Ported from frost-ristretto255/tests/rerandomized_tests.rs
 *
...
describe("FROST Ristretto255-SHA512 Re-randomized Tests", () => {
  let rng: CryptoRng;
  ...
  describe("Randomizer Properties", () => {
    it("should create randomizer from commitments", () => {
      ...
      const identifier = Identifier.fromU16(Ristretto255Sha512, 1);
    ...
    it("should serialize and deserialize randomizer", () => {
      ...
      const deserialized = Randomizer.deserialize(Ristretto255Sha512, serialized);
  ...
  describe("RandomizedParams", () => {
    it("should create params from randomizer", () => {
      ...
      const commitmentsData = signingCommitmentsData();
      const verifyingKeyElement = Ristretto255Sha512.deserializeElement(commitmentsData.hiding);
      const verifyingKey = VerifyingKey.create(Ristretto255Sha512, verifyingKeyElement);
  ...
  describe("Re-randomized Signing Flow", async () => {
    it("should complete re-randomized signing flow with dealer", async () => {
      ...
      const keyPackages = new Map<string, KeyPackage<typeof Ristretto255Sha512>>();
      ...
      const nonces = new Map<string, SigningNonces<typeof Ristretto255Sha512>>();
      ...
      const signingPackage: SigningPackage<typeof Ristretto255Sha512> = {
      ...
      const signatureShares = new Map<
        Identifier<typeof Ristretto255Sha512>,
        SignatureShare<typeof Ristretto255Sha512>
      >();
  ...
  describe("Unlinkability", () => {
    it("should produce different randomized keys for same group key", async () => {
      ...
      for (const idHex of participantIds) {
        ...
        const [, signingCommitments] = commit(Ristretto255Sha512, keyPackage.signingShare, rng);
        commitmentsMap.set(keyPackage.identifier, signingCommitments);
      }
