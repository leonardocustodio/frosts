 ...
 */
export interface Challenge<C extends Ciphersuite> {
 ...
 * This is a forward reference to the keys module.
 */
export interface VerifiableSecretSharingCommitment<C extends Ciphersuite> {
...
export class VerifyingKey<C extends Ciphersuite> {
   ...
   * @internal
   */
  verifyPrehashed(challenge: Challenge<C>, signature: Signature<C>): void {
    const group = this._ciphersuite.group;
