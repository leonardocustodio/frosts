...
interface IdentifierLike<_C extends Ciphersuite> {
  toString(): string;
}
type Identifier<C extends Ciphersuite> = IdentifierLike<C>;
...
export class FrostError<C extends Ciphersuite> extends Error {
   ...
   */
  public readonly culpritIdentifiers: Identifier<C>[];
   ...
   */
  public readonly culpritIdentifier: Identifier<C> | null;
  ...
  private constructor(
    type: FrostErrorType,
    options?: {
      culprits?: Identifier<C>[];
      culprit?: Identifier<C> | null;
      fieldError?: FieldError;
      groupError?: GroupError;
    },
  ) {
   ...
   */
  static invalidSignatureShare<C extends Ciphersuite>(culprits: Identifier<C>[]): FrostError<C> {
   ...
   */
  static invalidSecretShare<C extends Ciphersuite>(culprit?: Identifier<C> | null): FrostError<C> {
   ...
   */
  static invalidProofOfKnowledge<C extends Ciphersuite>(culprit: Identifier<C>): FrostError<C> {
