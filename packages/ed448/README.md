...
This package is a re-export of the ciphersuite-generic [@frosts/core](https://www.npmjs.com/package/@frosts/core) package, parametrized with the Ed448 curve. For more details, refer to [The ZF FROST Book](https://frost.zfnd.org/).
