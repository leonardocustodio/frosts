...
/**
 * FROST ESLint configuration for TypeScript packages.
 *
 * Uses modern ESLint flat config format (ESLint 9+) with strict
 * type checking for maximum type safety and code quality.
 */
